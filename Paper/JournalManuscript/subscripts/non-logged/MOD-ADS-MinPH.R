...
ads.bas <-  lmer(ads.minph ~ 1 + (1|Corpus), data = adsratedata, REML = F)
...
ads.mph.nsb <-  lmer(ads.minph ~ n_sibs +
                       (1|Corpus), data = adsratedata, REML = F)
...
# 0. Random effects only (base model)
ads.agd.bas <-  lmer(ads.minph ~ 1 + (1|Corpus) + (1|ID),
...
ads.agd.mph.nsb <-  lmer(ads.minph ~ n_sibs +
                       (1|Corpus) + (1|ID), data = adsratedata.agd, REML = F)
...
# 0. Random effects only (base model)
ads.agd.s.bas <-  lmer(ads.minph ~ 1 + (1|Corpus) + (1|ID),
...
ads.agd.s.mph.nsb <-  lmer(ads.minph ~ n_sibs +
                       (1|Corpus) + (1|ID), data = adsratedata.agd.sub,
                       REML = F)
