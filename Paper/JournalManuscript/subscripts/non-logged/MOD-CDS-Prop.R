...
cds.prp.bas <-  lmer(prp.cds ~ 1 + (1|Corpus), data = propCDS, REML = F)
...
# 0. Random effects only (base model) ####
cds.prp.agd.s.bas <-  lmer(prp.cds ~ 1 + (1|Corpus) + (1|ID),
